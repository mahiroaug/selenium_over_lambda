...
def lambda_handler(event, context):
    ...
    ### get value ################################
    ### get point
    xpath = "//*[@id='withdrawal-table']/tbody/tr[1]/td[3]/span/span"
    object_value = browser.find_elements(by=By.XPATH, value=xpath)
    if object_value:
        print("object_balue: ",object_value)
    else:
        print("not object")    
...
def generate_url(validators):  
    url = "https://beaconcha.in/validator/802713#withdrawals"
    return url
