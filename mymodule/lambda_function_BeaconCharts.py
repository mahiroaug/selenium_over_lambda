...
def lambda_handler(event, context):
    ...
    ### put S3
    full_key = f"{key}/png/BeaconCharts_{current_formed}.png"
    ...
    attachments = [
        {
            "pretext": f"<!channel> ({current_formed}) 本日のEthereumネットミャーク🎵",
            "color": "#FFA500",
            "author_name": "beaconcha.in - Mainnet",
            "title": "Charts from the Ethereum Network",
            "title_link": URL,
            "text": "Ethereumネットワーク状態の定点観測になりますー",
            "image_url": image_url,
...
def generate_url():  
    url = "https://beaconcha.in/charts/slotviz"
    return url
